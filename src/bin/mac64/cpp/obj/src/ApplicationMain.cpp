...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::openfl::Lib_obj::setPackage(HX_CSTRING("Matt Wells"),HX_CSTRING("TestGame"),HX_CSTRING("TestGame"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(35)
		::openfl::Lib_obj::create( Dynamic(new _Function_1_1()),(int)1205,(int)673,(int)60,(int)13794305,(int((int((int((int((int((int((int((int((int((int(::openfl::Lib_obj::HARDWARE) | int(::openfl::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::openfl::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("TestGame"),null(),null());
	}
return null();
}
