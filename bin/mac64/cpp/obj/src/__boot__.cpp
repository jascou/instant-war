...
::tenblock::SpritePack_obj::__register();
::tenblock::Scenario_obj::__register();
::tenblock::GameMap_obj::__register();
::tenblock::GameEgo_obj::__register();
::tenblock::GameSprite_obj::__register();
::tenblock::CharSprite_obj::__register();
...
::tenblock::CharSprite_obj::__boot();
::tenblock::GameSprite_obj::__boot();
::tenblock::GameEgo_obj::__boot();
::tenblock::GameMap_obj::__boot();
::tenblock::Scenario_obj::__boot();
::tenblock::SpritePack_obj::__boot();
}
