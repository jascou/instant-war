...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Matt Wells", "TestGame", "TestGame", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "TestGame", null, { width: 1205, height: 673 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 1205, height: 673 });
			#end
